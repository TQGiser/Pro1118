<template>
    <el-upload ref="upload" :before-upload="upload" :show-file-list="false" accept=".xlsx,.xls"
        style="width: 100px; display: inline-flex">
        <el-button type="primary"> 打开excel </el-button>
    </el-upload>
    <div id="ted" v-for="item in projs" :key="item.key" >
        <!-- <h1>{{item['项目名称'] }}</h1> -->

        <pie_e :proName="item['项目名称']" :proProgres = "item['完成进度']"
        :proCon="item['完成内容']"></pie_e>
    </div>
</template>
